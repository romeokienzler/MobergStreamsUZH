...
#ifndef BEJWRMXQYSUKSSQQAC4SCC2_H_
#define BEJWRMXQYSUKSSQQAC4SCC2_H_
...
#define SELF BeJwrMXQySUksSQQAC4sCC2
...
#undef SELF
#endif // BEJWRMXQYSUKSSQQAC4SCC2_H_ 
